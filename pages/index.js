...
import {
    SiReact, SiTailwindcss, SiExpress, SiMongodb, SiFirebase,
    SiPython, SiJavascript, SiCplusplus, SiGnubash,
    SiLinux, SiRaspberrypi, SiDocker, SiBlender, SiAutodesk
} from "react-icons/si"
...
const Banner = () => {
    return (
        <div className="relative w-full h-screen pt-16 lg:pl-40 flex flex-col items-center justify-center bg-scroll bg-bottom bg-cover bg-no-repeat"
            style={{ backgroundImage: `url(${BackgroundImg.src})` }}>
            <div className="w-full md:w-5/6 lg:w-4/5 md:max-w-3xl h-60 relative py-2 mx-4 mt-32 md:mx-0 md:mt-0 bg-slate-700/40 
                        rounded-none md:rounded-full flex flex-col md:items-end justify-evenly">
                <div className="absolute rounded-full w-60 h-60 lg:w-80 lg:h-80 -top-56 inset-x-0 mx-auto  
            ...
            <Link href="#about">
                <a className=" relative text-primary text-lg px-5 py-2 5 mt-16 rounded-lg border-primary border-2 hover:text-slate-900
             hover:bg-primary/60 top-0 hover:top-0.5 transition-all ease-in-out duration-800">
                    About Me
                </a>
            </Link>
        </div>
...
const About = () => {
    ...
    return (
        <div className="relative w-full my-8 px-4 md:px-0 md:w-5/6 lg:w-4/5 md:max-w-5xl">
            ...
            <h1 className="text-5xl font-thin text-slate-800 dark:text-gray-300 py-4">ABOUT</h1>

            <ScrollTrigger
                className="relative "
                onEnter={() => setTrigger1(true)}
            >
                <div className="relative w-32 h-32">
                    <div className="absolute h-auto w-auto inset-0 m-2 rounded-full flex items-center justify-center bg-slate-200 dark:bg-slate-800 shadow-28 z-10">
...
const Skills = () => {
    ...
    return (
        <div className="relative w-full my-8 px-4 md:px-0 md:w-5/6 lg:w-4/5 md:max-w-5xl">
            ...
            <h1 className=" text-5xl font-thin text-slate-800 dark:text-gray-300 pb-2">SKILLS</h1>
            <ScrollTrigger
                className="w-full my-2 lg:grid lg:grid-cols-2 lg:gap-2"
                onEnter={() => setTrigger(true)}
            // onExit={() => setTrigger(false)}
            >
                <div className="relative w-full px-4 py-4 rounded-2xl top-0 left-0
    ...
    return (
        <div className="mx-auto w-5/6 my-4 flex items-center wrap justify-center">
            ...
            <div className="w-5/6">
                ...
                <Expbar
                    width={percent}
                    barColor={"bg-secondary dark:bg-primary"}
                    isTrigger={trigger} />
            </div>
        </div>
    )
...
const Experience = () => {
    return (
        <div className="w-full my-8 px-4 md:px-0 md:w-5/6 lg:w-4/5 md:max-w-5xl">
            <h1 className=" text-5xl font-thin text-slate-800 dark:text-gray-300 py-4">EXPERIENCE</h1>
            <ul className="relative ml-auto w-11/12 my-4 border-l-2 border-gray-400 dark:border-gray-500">
                <li className="mb-10 ml-10 ">
                    <span className="absolute w-8 h-8 flex items-center justify-center rounded-full -left-4 ring-8 
                    ...
                    <ul className="text-base font-normal text-gray-600 dark:text-gray-300 list-disc">
                        ...
                        <li className="ml-4 mb-2">
                            Build air sampling system and prepare control GUI using Tkinter.
                        </li>
                        <li className="ml-4 mb-2">
                        ...
                        <li className="ml-4 mb-2">
                            Improve remote connection issue in field study with openVPN.
                        </li>
                    </ul>
                    <br />
                    <ul className="text-base font-normal text-gray-600 dark:text-gray-300 list-disc">
                        ...
                        <li className="ml-4 mb-2">
                            Hardware build and operating system (CentOS and Ubuntu) installation.
                        </li>
                        <li className="ml-4 mb-2">
                            Compile and test 16 softwares.
                        </li>
                    </ul>
                    <br />
                    <ul className="text-base font-normal text-gray-600 dark:text-gray-300 list-disc">
                        ...
                        <li className="ml-4 mb-2">
                            Air pollution hands-on course with Raspberry Pi (from serial communication protocols to webhook with Flask and Dialogflow).
                        </li>
                        <li className="ml-4 mb-2">
                            Scientific manuscript of model simulation.
                        </li>
                    </ul>
                </li>
            </ul>
...
const Education = () => {
    return (
        <div className="w-full my-8 px-4 md:px-0 md:w-5/6 lg:w-4/5 md:max-w-5xl">
            <h1 className=" text-5xl font-thin text-slate-800 dark:text-gray-300 py-4">EDUCATION</h1>
            <ul className="relative ml-auto w-11/12 my-4 border-l-2 border-gray-400 dark:border-gray-500">
                <li className="mb-10 ml-10 ">
                    <span className="absolute w-8 h-8 flex items-center justify-center rounded-full -left-4 ring-8 
                                   ring-slate-200 dark:ring-slate-800 bg-secondary dark:bg-primary">
