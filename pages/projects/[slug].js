        ...
        <>
            ...
            <div className="w-full min-h-screen flex flex-col items-center justify-start pt-12 pb-16">
                <div className="relative w-full my-8 px-4 md:px-0 md:w-5/6 lg:w-4/5 md:max-w-3xl">
                    <Link href='/projects' >
                        <a className=" text-secondary dark:text-primary text-md px-5 py-2 5 mt-16 rounded-lg border-secondary dark:border-primary border-2 hover:text-surface dark:hover:text-background
             hover:bg-secondary dark:hover:bg-primary transition-all ease-in-out duration-800">
                    ...
                    <h3 className="inline-block mb-2 text-3xl md:text-4xl font-thin text-slate-800 dark:text-gray-300">{title}</h3>
                    <div className="flex items-center flex-wrap my-2">
                        <p className="text-sm md:text-base text-slate-800 dark:text-gray-300 mr-2">
                            Techs :
                        </p>
                        {tags.map((tag, index) => (
                            <span
                    ...
                    <ReactMarkdown className="markdown text-slate-800 dark:text-gray-300">
                        {content}
                    </ReactMarkdown>
