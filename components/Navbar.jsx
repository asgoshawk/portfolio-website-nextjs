...
const Navbar = () => {
    ...
    return (
        <nav className="w-full min-h-[4rem] py-4 px-6 md:px-16 flex flex-wrap items-center justify-between fixed top-0 inset-x-0 z-50 
        bg-slate-800/40 dark:bg-slate-800/20 backdrop-filter backdrop-blur-sm">
            ...
            <div id="navMenu" className="hidden w-full order-3 md:block md:w-auto md:order-1 md:ml-auto">
                <ul className="flex flex-col mt-4 md:mt-0 md:flex-row md:flex-wrap md: items-center">
                    ...
                    <li className={`w-full text-lg text-center my-2 py-2 md:py-0 md:my-0 md:mx-6 md:w-auto 
...
const ThemeIcon = () => {
    ...
    return (
        <span
            className="ml-6 mr-3 md:mr-0 hover:cursor-pointer"
            onClick={handleMode}
        >
            {darktheme ? (
